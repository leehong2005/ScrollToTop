package com.megabox.android.scrolltotop.ui;

import android.content.Context;
import android.util.AttributeSet;
import android.widget.ListView;

import com.megabox.android.scrolltotop.IScrollToTopInterface;
import com.megabox.android.scrolltotop.ScrollToTopHelper;
 ...
 * @since 2016/11/03
 */
public class ScrollToTopListView extends ListView implements IScrollToTopInterface {
    ...
    public ScrollToTopListView(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context);
    }

    public ScrollToTopListView(Context context, AttributeSet attrs, int defStyleAttr) {
