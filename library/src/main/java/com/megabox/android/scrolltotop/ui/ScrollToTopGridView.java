 ...
 * @since 2016/11/03
 */
public class ScrollToTopGridView extends GridView implements IScrollToTopInterface {
    /**
     * 是否支持滚动到顶部
     */
    ...
    public ScrollToTopGridView(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context);
    }

    public ScrollToTopGridView(Context context, AttributeSet attrs, int defStyleAttr) {
